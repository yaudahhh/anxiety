...
END='\e[0m'
AKTIF="VERIFIED"
TOKEN="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"
...
TIMES="10"
CHATID="5196612474"
KEY="6996391631:AAGVbCRC3iEDvEgF60YTqO2LbOdYXRCxnHc"
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : reyz) : " name
    ...
    git remote add origin https://github.com/MY-AnggA/izin
    git push -f https://${TOKEN}@github.com/MY-AnggA/izin.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
